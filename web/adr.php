...
<div>
  <div class="row">
    <div class="col-md-2 col-lg-offset-1 col-sm-6 col-xs-12">
      ...
      <div class="container">
        <p>Owners:</p>
        <div class="container col-xs-12 col-xs-offset-1" id="userinfo">
          <div>
...
<!-- gets filled dynamically --> 
      ...
      <div class="container"><div class="btn-toolbar col-lg-offset-0 col-lg-12" role="toolbar">
      </div>
      </div></div>
    </div></form>
    </div>
    <div class="col-md-3 col-xs-12 col-sm-6 col-md-offset-1">
      <form action="users.php" method="post" name="users" id="usersContainer">
      <div class="container">
        <p>Permitted Addresses:</p>
        <div class="container col-xs-12 col-xs-offset-1" id="userinfo">
          <div>
<select name="users" size="12" class="defaultbgcolor" id="permadrs">
<!-- gets filled dynamically --> 
        <option value="0" style="font-style:italic">Create New User   </option>
</select>
      </div><br />
      <div class="container"><div class="btn-toolbar col-xs-offset-1 col-xs-12" role="toolbar">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-offset-1"><form action="users.php" method="post" id="userdata">
